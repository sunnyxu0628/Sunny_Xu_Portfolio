      ...
      <div className="header-content">
        <div className="profile-section">
          ...
          <div className="profile-info">
            ...
            <p className="title">Workforce Systems Manager & Data Analyst</p>
            <p className="bio">
              I specialize in integrating education and workforce datasets, building analytical tools, and
              delivering actionable insights to support Career Technical Education and workforce development.
              I enjoy automating processes with Python and visualizing data with Power BI.
            </p>
